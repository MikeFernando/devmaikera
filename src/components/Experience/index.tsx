  ...
  return (
    <section className="mx-auto flex flex-col items-center justify-center p-5 md:min-h-screen lg:-mb-32 lg:max-w-7xl lg:py-20">
      <div className="flex flex-col items-center justify-center text-4xl font-bold leading-tight md:mb-24 lg:flex lg:flex-row lg:items-center lg:gap-28">
        <h2 className="mt-8 bg-gradient-to-tr from-gray-200 to-gray-300 bg-clip-text font-montserrat text-3xl font-extrabold uppercase text-transparent sm:text-4xl lg:max-w-xs lg:break-all lg:text-9xl lg:tracking-wider">
          Experience
        </h2>
        <ol className="group mt-6 dark:border-gray-700 lg:mt-0 lg:flex-1 lg:border-l lg:border-gray-200">
          <div className="min-w-[300px] flex-col items-center justify-center sm:flex-1 lg:pl-20">
            ...
            {/* <!-- [2020] --> */}
            <div className="relative mb-5 flex flex-col rounded-lg bg-neutral-50 shadow-md duration-500 hover:!scale-100 group-hover:scale-[0.99] sm:flex-row sm:gap-5">
              ...
              <div className="flex w-[100%] max-w-xs flex-col gap-y-[10px] p-5">
                <h3 className="hidden font-montserrat text-lg font-bold uppercase text-gray-950 sm:flex">
                  Beginner
                </h3>
