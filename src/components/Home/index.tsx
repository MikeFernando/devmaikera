...
export const Main = () => {
  return (
    <main className="flex flex-col items-center justify-between overflow-hidden rounded-3xl bg-gray-50 shadow-md md:mt-24 lg:mx-auto lg:mt-28 lg:max-w-5xl xl:max-w-7xl">
      <div className="flex flex-col items-center">
        ...
        <button
          type="button"
          className="my-4 rounded-full bg-varianteBlue px-5 py-3 text-center font-medium text-white hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 md:text-xs lg:text-sm"
        >
          See website 👇
        </button>
      </div>
